...
http://theoryx5.uwinnipeg.ca/CPAN/perl/pod/perlmodinstall.html 在线阅读。
...
http://www.cpan.org/authors/id/G/GA/GAAS/MIME-Base64-2.12.tar.gz 进行安装。
...
在老的LWP版本中, 加载模块HTTP::Cookies::Netscape使用的是use HTTP::Cookies 而并不是你所期望的use HTTP::Cookies::Netscape。此外，老的版本不能识别较新Mozilla版本的cookies文件. 一个更加令人信服的例子是在老版本的LWP中, LWP::UserAgent没有$browser->get或者$browser->post方法,而本书中使用得很频繁，因为我们替换了use HTTP::Request::Common; $browser->request(GET(...),...);这种非常不友好的语法.
